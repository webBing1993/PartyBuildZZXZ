...
(function (d, p, q, u) {
    ...
    methods = {
        ...
        open: function (a, b) {
            if(isRun){
                localStorage.setItem('ShowId', b.data('id'));
                var c, f, e, g, h, m = closeBtnTpl = overlayTpl = iframeTpl = "", l = d(a.box), p = b.attr("class"),
                    q = a.modalBg, t = a.closeBg;
                ...
                0 != a.closeHide && (closeBtnTpl = '<a id="HCloseBtn" title="\u5173\u95ed" style="width:24px;height:24px;line-height:24px;display:inline-block;cursor:pointer;background-color:' + t + ';color:#fff;font-size:1.4em;text-align:center;position:absolute;top:-1rem;right:8px;z-index: 99999999;"><span style="width:24px;height:24px;display:inline-block;"><img src="/home/images/service/icon_04.png" id="close"></span></a>');
                ...
                0 != a.isOverlay && (overlayTpl = "<div id='HOverlay' style='width:" + r.width() + "px;height:" + r.height() + "px;background-color:" + q + ";position:fixed;top:0;left:0;z-index:99;'></div>");
