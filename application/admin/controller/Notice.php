    ...
    public function regularadd(){
        ...
        if($id){
            ...
            if(IS_POST){
                ...
                $noticeModel = new NoticeModel();
                $data['create_user'] = $_SESSION['think']['user_auth']['id'];
                $model = $noticeModel->validate('Notice.other')->where(['id' => $id])->update($data);
                if($model){
...
//                'create_time' => array('egt',$t),
            ...
            int_to_string($infoes,array(
                'type' => array(1=>"上级政策",2=>"会议情况",3=>"党课情况",4=>"活动招募",5=>"活动情况",6=>"党性体检"),
            ));
...
//                'create_time' => array('egt',$t),
    ...
    public function push(){
        ...
        if($arr1 == -1){
            ...
            switch ($focus1['type']) {
                case 1:
                    $url1 = $httpUrl."/home/notice/relevant/id/".$focus1['id'].".html";
                    $pre1 = "【上级政策】";
                    break;
                case 2:
                    $url1 = $httpUrl."/home/notice/meet/id/".$focus1['id'].".html";
                    $pre1 = "【会议情况】";
                    break;
                case 3:
                    $url1 = $httpUrl."/home/notice/party/id/".$focus1['id'].".html";
                    $pre1 = "【党课情况】";
                    break;
                case 4:
                    $url1 = $httpUrl."/home/notice/recruit/id/".$focus1['id'].".html";
                    $pre1 = "【活动招募】";
                    break;
                case 5:
                    $url1 = $httpUrl."/home/notice/activity/id/".$focus1['id'].".html";
                    $pre1 = "【活动情况】";
                    break;
                case 6:
                    $url1 = $httpUrl."/home/notice/regular/id/".$focus1['id'].".html";
                    $pre1 = "【党性体检】";
                    break;
                default:
                    break;
        ...
        if(!empty($arr2)) {
            ...
            foreach ($arr2 as $key=>$value){
                ...
                switch ($focus['type']) {
                    case 1:
                        $url = $httpUrl."/home/notice/relevant/id/".$focus['id'].".html";
                        $pre = "【上级政策】";
                        break;
                    case 2:
                        $url = $httpUrl."/home/notice/meet/id/".$focus['id'].".html";
                        $pre = "【会议情况】";
                        break;
                    case 3:
                        $url = $httpUrl."/home/notice/party/id/".$focus['id'].".html";
                        $pre = "【党课情况】";
                        break;
                    case 4:
                        $url = $httpUrl."/home/notice/recruit/id/".$focus['id'].".html";
                        $pre = "【活动招募】";
                        break;
                    case 5:
                        $url = $httpUrl."/home/notice/activity/id/".$focus['id'].".html";
                        $pre = "【活动情况】";
                        break;
                    case 6:
