...
//                'create_time' => array('egt',$t),
    ...
    public function push(){
        ...
        if($arr1 == -1){
            ...
            $url1 = $httpUrl."/home/college/forumnotice/id/".$focus1['id'].".html";
            $pre1 = "【论坛通知】";
            $path1 = $httpUrl."/home/images/redforum.png";
            $information1 = array(
                "title" => $pre1.$title1,
        ...
        if(!empty($arr2)) {
            ...
            foreach ($arr2 as $key=>$value){
                ...
                $url = $httpUrl."/home/college/forumnotice/id/".$focus['id'].".html";
                $pre = "【论坛通知】";
                $path = $httpUrl."/home/images/redforum.png";
                $info = array(
                    "title" => $pre.$title,
                    "description" => $content,
                    "url" => $url,
