    ...
    public function index(){
        ...
        foreach($list as $value){
            ...
            $map1 = [
                ...
                'status' => ['egt',0],
                'learns_id' => array('exp',"is not null"),
            ];
            $map2 = [
                'user_id' => $value['userid'],
                'status' => ['egt',0],
            ...
            $map7 = [
                'user_id' => $value['userid'],
                'status' => ['egt',0],
                'meet_id' => array('exp',"is not null"),
            ];
            $map8 = [
                'user_id' => $value['userid'],
                'status' => ['egt',0],
                'mediation_case_id' => array('exp',"is not null"),
            ];
            $value['week'] = $this->get_count($map1,'w') + $this->get_count($map2,'w') + $this->get_count($map3,'w') + $this->get_count($map4,'w') + $this->get_count($map5,'w') + $this->get_count($map6,'w') + $this->get_count($map7,'w') + $this->get_count($map8,'w');  // 周
            $value['mouth'] = $this->get_count($map1,'m') + $this->get_count($map2,'m') + $this->get_count($map3,'m') + $this->get_count($map4,'m') + $this->get_count($map5,'m') + $this->get_count($map6,'m') + $this->get_count($map7,'m') + $this->get_count($map8,'m');  // 月
            $value['year'] = $this->get_count($map1,'y') + $this->get_count($map2,'y') + $this->get_count($map3,'y') + $this->get_count($map4,'y') + $this->get_count($map5,'y') + $this->get_count($map6,'y') + $this->get_count($map7,'y') + $this->get_count($map8,'y'); // 年
            // 组织生活
            /*$maps1 = [
                'user_id' => $value['userid'],
                'status' => ['egt',0],
